    ...
    private void BrowseWrite() {
        ...
        allRecordsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot1) {
                ...
                mAdapter = new RecordAdapter(MyRecordsFragment.this.getActivity(), records);
                ...
                mAdapter.setOnItemClickListener(new RecordAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(String Rid) {
                        ...
                        switch (type) {
                            case 1:
                                Intent intentPrescriptionList = new Intent(MyRecordsFragment.this.getActivity(), ViewPrescription.class);
                                intentPrescriptionList.putExtra("recordID", Rid);
                                startActivity(intentPrescriptionList);
                                break;
                            case 2:
                                Intent intentMyBloodTests = new Intent(MyRecordsFragment.this.getActivity(), ViewBloodTest.class);
                                intentMyBloodTests.putExtra("recordID", Rid);
                                startActivity(intentMyBloodTests);
                                break;
                            case 3:
                                Intent intentMyx_Rays = new Intent(MyRecordsFragment.this.getActivity(), ViewXRay.class);
                                intentMyx_Rays.putExtra("recordID", Rid);
                                startActivity(intentMyx_Rays);
                                break;
                            case 4:
                                Intent intentMyVital = new Intent(MyRecordsFragment.this.getActivity(), ViewVitalSigns.class);
                                intentMyVital.putExtra("recordID", Rid);
                                startActivity(intentMyVital);
                                break;
                            case 5:
                                Intent intentRecord = new Intent(MyRecordsFragment.this.getActivity(), ViewRecord.class);
