...
public class WriteXRay extends AppCompatActivity {
    ...
    String type,pid,requestKey,req;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_xray);
        ...
        hintbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = new Dialog(WriteXRay.this);
                ...
                hint.setText("All fields and file required.");
        ...
        cal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(WriteXRay.this,android.R.style.Theme_DeviceDefault_Dialog_MinWidth,mDatasetListner,year,month,day);
        ...
        attachmentView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(WriteXRay.this, "No Application available to view PDF", Toast.LENGTH_SHORT).show();
                }
            }
        });
