...
public class EditBloodTest extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_blood_test);
...
// retrieve info
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // openDialog();
                final Dialog dialog = new Dialog(EditBloodTest.this);
        ...
        attachmentView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(EditBloodTest.this, "No Application available to view PDF", Toast.LENGTH_SHORT).show();
                }
            }
        });
                        ...
                        recordRef.child(recordIDٍ).child("BloodTest").child(key)
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(EditBloodTest.this, "Test deleted.", Toast.LENGTH_SHORT).show();
                                }
                                else {
                                    Toast.makeText(EditBloodTest.this, "Test not deleted.", Toast.LENGTH_SHORT).show();
                                }
                            }
    ...
    private void AddBloodTest(String test,String unit,Double result, Double normalmin, Double normalmax) {
        ...
        ref.child(test).updateChildren(btmap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                ...
                if (task.isSuccessful()) {
                    Toast.makeText(EditBloodTest.this, "BloodTest Added", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(EditBloodTest.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                }
